...
- This service manages Kubernetes namespaces used by CI/CD workloads. It applies lifecycle policies, tracks namespace health, and deletes stale or failed namespaces through the action controller.
